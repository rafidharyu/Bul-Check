                                        ...
                                        <td width="25%">
                                            <div class="form-group">
                                                <select name="kondisi[]" id="kondisi" class="form-control">
                                                    ...
                                                    <option value="{{ $gejala->id }}_1">Pasti Ya</option>
                                                    <option value="{{ $gejala->id }}_2">Hampir Pasti Ya</option>
                                                    <option value="{{ $gejala->id }}_3">Kemungkinan Besar Ya</option>
                                                    <option value="{{ $gejala->id }}_4">Mungkin Ya</option>
                                                    <option value="{{ $gejala->id }}_4">Hampir Mungkin</option>
